<?php
    ...
    if(isset($_SESSION['usuario'])){
        header("location: ../administrador/dahsboard.php");
    }
?>
<!DOCTYPE html>
<html>
...
<body  >
    ...
    <div  class="container">
           ...
           <div class="form sign-in-container">
            ...
            <form action="login_usuario.php" method="POST" class="formulario2">
            
              <input class="fas fa-key icon" type="email" name="email" placeholder="email" id="email2"> 
              <input class="fas fa-key icon" type="password" name="password" placeholder="contrasena" id="password2">
